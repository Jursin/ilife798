...
![iOS](https://img.shields.io/badge/iOS-%E2%89%A515-blue?logo=apple&logoColor=000000)
![License](https://img.shields.io/github/license/Jursin/ilife798?logo=github)
![GitHub Release](https://img.shields.io/github/v/release/Jursin/ilife798?include_prereleases&logo=github)
![GitHub Downloads](https://img.shields.io/github/downloads/Jursin/ilife798/total?logo=github)
[![afdian](https://img.shields.io/badge/爱发电-赞助我-946CE6?logo=afdian)](https://afdian.com/a/jursin)
...
- **设备：**
  - 设备列表显示设备类型 Tab
  - 输入设备编号/扫码/NFC 识别（需自行将包名改为 `com.cloudora.android`）添加设备
...
# 产出未签名 IPA：iosApp/build/dist/ilife798-ios-unsigned.ipa
...
```sh
unzip ilife798-ios-unsigned.ipa -d /tmp/ios-sign
